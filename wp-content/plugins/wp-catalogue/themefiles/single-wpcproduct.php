...
<?php 
	...
	echo '<div class="wp-catalogue-breadcrumb"> <a href="'.$catalogue_page_url.'">Toate produsele</a> &gt;&gt; <a href="'.$cat_url.'">'.$tname.'</a>  ' . $pname . '</div>';
?>
	...
	echo '<div id="wpc-col-1">
			...
			if($count>0){
				echo '<li class="wpc-category"><a href="'. get_option('catalogue_page_url') .'">Toate produsele</a></li>';
    ...
    <!--/Left-menu-->
        ...
        ?>	 
                    ...
                    ?>
                    <!-- The title for the single page product -->
                    <h4 style="color: #11A04E; font-weight: bold;">
                    <?php
                        if( !empty($title) )
                        {
                            echo $title;
