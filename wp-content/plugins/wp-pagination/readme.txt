...
jPages for WordPress integrates the cool pagination for gallery,comments,table.
...
<a href="http://blog.kishorechandra.co.in/what-is-eod-for-software-engineer/">Here is demo link</a>

For adding pagination for table:
Add id "jpages-table" to table and id jpages-table-body-list to tbody
<a href="http://blog.kishorechandra.co.in/pagination-table/">Here is demo link</a>
...
For Support <a href="http://crayonux.com/questions/">Click Here</a>
...
1. A standard WordPress gallery turned into a gallery with pagination.
...
= 1.1 =
Added a option for choosing no of comments per page. We can set it in Discussion Settings.
BUT DO NOT CHECK THE CHECK BOX FOR Break comments into page CHECK BOX.
